...
# instance fields
.field public mAppProfileService:Lcom/nvidia/NvAppProfileService;
...
.method private final completeResumeLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    .line 1220
    :goto_0
    iget-object v1, p0, Lcom/android/server/am/ActivityStack;->mAppProfileService:Lcom/nvidia/NvAppProfileService;

    iget-object v2, p1, Lcom/android/server/am/ActivityRecord;->packageName:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/nvidia/NvAppProfileService;->setAppProfile(Ljava/lang/String;)V
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIILandroid/os/Bundle;Z[Lcom/android/server/am/ActivityRecord;)I
    ...
    .line 2416
    const-wide/32 v34, 0x59682f00

    .line 2417
    .local v34, pokeTimeout:J
    ...
    iget-object v3, v0, Lcom/android/server/am/ActivityStack;->mAppProfileService:Lcom/nvidia/NvAppProfileService;

    const/4 v4, 0x2

    const-wide/32 v5, 0x59682f00

    invoke-virtual/range {v3 .. v8}, Lcom/nvidia/NvAppProfileService;->requestMinOnlineCpuCount(IJJ)V
    ...
    invoke-virtual/range {v3 .. v8}, Lcom/nvidia/NvAppProfileService;->requestCpuFreqMin(IJJ)V
    ...
    invoke-virtual {v0, v5, v6, v9, v10}, Landroid/content/Intent;->toShortString(ZZZZ)Ljava/lang/String;
    ...
    .restart local v34       #pokeTimeout:J
    :cond_4
    const/16 v38, 0x0
    ...
    iput-wide v4, v3, Lcom/android/server/am/ActivityManagerService;->mAppSwitchesAllowedTime:J
    ...
    invoke-virtual/range {v13 .. v18}, Lcom/android/server/am/ActivityStack;->startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;IZLandroid/os/Bundle;)I
