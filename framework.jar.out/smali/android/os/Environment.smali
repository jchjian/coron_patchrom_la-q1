...
.field private static final SDCARD_STORAGE_DIRECTORY:Ljava/io/File; = null
...
.field private static final USB_STORAGE_DIRECTORY1:Ljava/io/File;

.field private static final USB_STORAGE_DIRECTORY2:Ljava/io/File;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/os/Environment;->SDCARD_STORAGE_DIRECTORY:Ljava/io/File;

    .line 539
    const-string v0, "USB_STORAGE_1"
    ...
    sput-object v0, Landroid/os/Environment;->USB_STORAGE_DIRECTORY1:Ljava/io/File;

    .line 556
    const-string v0, "USB_STORAGE_2"

    const-string v1, "/mnt/usbdrive2"

    invoke-static {v0, v1}, Landroid/os/Environment;->getDirectory(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;

    move-result-object v0

    sput-object v0, Landroid/os/Environment;->USB_STORAGE_DIRECTORY2:Ljava/io/File;
...
.method public static getInternalStorageDirectory()Ljava/io/File;
    ...
    const-string/jumbo v1, "persist.sys.primary.storage"
    ...
    :cond_0
    sget-object v0, Landroid/os/Environment;->SDCARD_STORAGE_DIRECTORY:Ljava/io/File;
...
.method public static getSdcardStorageState()Ljava/lang/String;
    ...
    .line 532
    .local v0, mountService:Landroid/os/storage/IMountService;
    invoke-static {}, Landroid/os/Environment;->getSdcardStorageDirectory()Ljava/io/File;
...
.method public static getUsb1StorageDirectory()Ljava/io/File;
    .locals 1

    .prologue
    .line 553
    sget-object v0, Landroid/os/Environment;->USB_STORAGE_DIRECTORY1:Ljava/io/File;

    return-object v0
.end method

.method public static getUsb1StorageState()Ljava/lang/String;
    .locals 3
    ...
    .line 546
    .local v0, mountService:Landroid/os/storage/IMountService;
    invoke-static {}, Landroid/os/Environment;->getUsb1StorageDirectory()Ljava/io/File;
...
.method public static getUsb2StorageDirectory()Ljava/io/File;
    .locals 1

    .prologue
    .line 570
    sget-object v0, Landroid/os/Environment;->USB_STORAGE_DIRECTORY2:Ljava/io/File;

    return-object v0
.end method

.method public static getUsb2StorageState()Ljava/lang/String;
    .locals 3
    ...
    .line 563
    .local v0, mountService:Landroid/os/storage/IMountService;
    invoke-static {}, Landroid/os/Environment;->getUsb2StorageDirectory()Ljava/io/File;
...
.method public static isPhoneStorageSupported()Z
    .locals 2

    .prologue
    .line 485
    const-string/jumbo v0, "ro.product.hasphonestorage"
