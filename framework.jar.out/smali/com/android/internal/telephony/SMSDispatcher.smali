...
.field protected static final EVENT_GET_SMS_CENTER_OVER:I = 0x8
...
.field protected static sSendRef:I
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/internal/telephony/SMSDispatcher;->sSendRef:I
...
.method protected constructor <init>(Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/SmsStorageMonitor;Lcom/android/internal/telephony/SmsUsageMonitor;)V
    ...
    const-string/jumbo v3, "sms_outgoing_check_interval_ms"
    ...
    const-string/jumbo v3, "sms_outgoing_check_max_count"
...
.method protected dispatchNormalMessage(Lcom/android/internal/telephony/SmsMessageBase;)I
    ...
    const-string v5, "dispatchNormalMessage"
    ...
    iget-object v4, v3, Lcom/android/internal/telephony/SmsHeader;->concatRef:Lcom/android/internal/telephony/SmsHeader$ConcatRef;
    ...
    iget-object v4, v3, Lcom/android/internal/telephony/SmsHeader;->portAddrs:Lcom/android/internal/telephony/SmsHeader$PortAddrs;
    ...
    const-string v5, "dispatchNormalMessage  dispatchWapPdu"

    invoke-static {v4, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 594
    iget-object v4, p0, Lcom/android/internal/telephony/SMSDispatcher;->mWapPush:Lcom/android/internal/telephony/WapPushOverSms;
    ...
    invoke-virtual {p1}, Lcom/android/internal/telephony/SmsMessageBase;->getServiceCenterAddress()Ljava/lang/String;
    ...
    .line 597
    .restart local v1       #pdus:[[B
    :cond_1
    iget-object v4, v3, Lcom/android/internal/telephony/SmsHeader;->portAddrs:Lcom/android/internal/telephony/SmsHeader$PortAddrs;

    iget v4, v4, Lcom/android/internal/telephony/SmsHeader$PortAddrs;->destPort:I

    invoke-virtual {p0, v1, v4}, Lcom/android/internal/telephony/SMSDispatcher;->dispatchPortAddressedPdus([[BI)V
    ...
    .line 601
    :cond_2
    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/SMSDispatcher;->dispatchPdus([[B)V
    ...
    .end local v1           #pdus:[[B
    :cond_3
    iget-object v0, v3, Lcom/android/internal/telephony/SmsHeader;->concatRef:Lcom/android/internal/telephony/SmsHeader$ConcatRef;

    .line 607
    .local v0, concatRef:Lcom/android/internal/telephony/SmsHeader$ConcatRef;
    iget-object v2, v3, Lcom/android/internal/telephony/SmsHeader;->portAddrs:Lcom/android/internal/telephony/SmsHeader$PortAddrs;

    .line 610
    .local v2, portAddrs:Lcom/android/internal/telephony/SmsHeader$PortAddrs;
    const-string v4, "SMS"

    const-string v5, "+++++++++processMessagePart++++++++++++"

    invoke-static {v4, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 611
    invoke-virtual {p0, p1, v0, v2}, Lcom/android/internal/telephony/SMSDispatcher;->processMessagePart(Lcom/android/internal/telephony/SmsMessageBase;Lcom/android/internal/telephony/SmsHeader$ConcatRef;Lcom/android/internal/telephony/SmsHeader$PortAddrs;)I
...
.method protected dispatchPdusCBM([[B)V
    .locals 3
    .parameter "pdus"
    ...
    const-string v2, "dispatchPdusCBM"
    ...
    const-string v1, "Marvell.sms.cbm.recevied.action"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-direct {p0, v2, v4, v9}, Lcom/android/internal/telephony/SMSDispatcher;->notifyAndAcknowledgeLastIncomingSms(ZILandroid/os/Message;)V
    :try_end_0
    ...
    invoke-direct {p0, v8, v9, v11}, Lcom/android/internal/telephony/SMSDispatcher;->notifyAndAcknowledgeLastIncomingSms(ZILandroid/os/Message;)V
    ...
    .line 383
    .local v7, smsCenter:Ljava/lang/String;
    iget-object v0, p1, Landroid/os/Message;->obj:Ljava/lang/Object;
    ...
    .end local v7           #smsCenter:Ljava/lang/String;
    check-cast v7, Ljava/lang/String;

    .line 387
    .restart local v7       #smsCenter:Ljava/lang/String;
    const-string v8, "SMS"
    ...
    const-string/jumbo v10, "z467 smsCenter = "
    ...
    invoke-virtual {p0, v10, v8}, Lcom/android/internal/telephony/SMSDispatcher;->removeMessages(ILjava/lang/Object;)V
...
.method protected abstract processCachedLongSmsWhenBoot()V
.end method

.method protected processCachedModemLongSmsWhenBoot()V
    .locals 0
...
.method protected processMessagePart(Lcom/android/internal/telephony/SmsMessageBase;Lcom/android/internal/telephony/SmsHeader$ConcatRef;Lcom/android/internal/telephony/SmsHeader$PortAddrs;)I
    ...
    const-string/jumbo v4, "z871 processMessagePart referenceNumber = "
    ...
    .restart local v16       #output:Ljava/io/ByteArrayOutputStream;
...
.method protected abstract sendMultipartSmsLast(Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;)V
.end method
...
.method protected abstract sendMultipartTextWithValidPri(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;II)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/String;",
...
.method protected sendRawPdu([B[BLandroid/app/PendingIntent;Landroid/app/PendingIntent;Z)V
    .locals 6
    .parameter "smsc"
    .parameter "pdu"
    .parameter "sentIntent"
    ...
    const-string/jumbo v5, "sendRawPdu "
    ...
    invoke-direct {v2, v1, p3, p4}, Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;-><init>(Ljava/util/HashMap;Landroid/app/PendingIntent;Landroid/app/PendingIntent;)V
    ...
    .line 1235
    .local v0, appName:Ljava/lang/String;
    iget-object v3, p0, Lcom/android/internal/telephony/SMSDispatcher;->mCounter:Lcom/android/internal/telephony/SMSDispatcher$SmsCounter;

    const/4 v4, 0x1

    invoke-virtual {v3, v0, v4}, Lcom/android/internal/telephony/SMSDispatcher$SmsCounter;->check(Ljava/lang/String;I)Z
    ...
    .line 1237
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/SMSDispatcher;->sendMultipartSms(Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;)V
    ...
    invoke-virtual {p0, v3, v2}, Lcom/android/internal/telephony/SMSDispatcher;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method protected sendRawPduWithRef([B[BLandroid/app/PendingIntent;Landroid/app/PendingIntent;IZZ)V
    .locals 6
    .parameter "smsc"
    .parameter "pdu"
    .parameter "sentIntent"
    .parameter "deliveryIntent"
    .parameter "mMessageRef"
    .parameter "more"
    .parameter "first"
    ...
    const-string/jumbo v5, "z1098 mMessageRef = "
    ...
    .line 1266
    .local v2, tracker:Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;
    iput p5, v2, Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;->mMessageRef:I
    ...
    .line 1283
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/SMSDispatcher;->sendMultipartSmsLast(Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;)V
...
.method protected abstract sendTextWithValidPri(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;III)V
.end method
