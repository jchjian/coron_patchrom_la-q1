...
.field public static STK_DEFAULT:Ljava/lang/String;
...
.method private constructor <init>(Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/IccRecords;Landroid/content/Context;Lcom/android/internal/telephony/IccFileHandler;Lcom/android/internal/telephony/IccCard;)V
    ...
    .line 103
    iput-boolean v0, p0, Lcom/android/internal/telephony/cat/CatService;->isDefaultInit:Z
...
.method private getMsgWhatString(I)Ljava/lang/String;
    .locals 1
    .parameter "what"
    ...
    .line 598
    :pswitch_1
    const-string v0, "MSG_ID_SESSION_END"

    goto :goto_0

    .line 600
    :pswitch_2
    const-string v0, "MSG_ID_PROACTIVE_COMMAND"

    goto :goto_0

    .line 602
    :pswitch_3
    const-string v0, "MSG_ID_EVENT_NOTIFY"

    goto :goto_0

    .line 604
    :pswitch_4
    const-string v0, "MSG_ID_REFRESH"

    goto :goto_0

    .line 606
    :pswitch_5
    const-string v0, "MSG_ID_CALL_SETUP"

    goto :goto_0

    .line 608
    :pswitch_6
    const-string v0, "MSG_ID_ICC_RECORDS_LOADED"

    goto :goto_0

    .line 610
    :pswitch_7
    const-string v0, "MSG_ID_RIL_MSG_DECODED"

    goto :goto_0

    .line 612
    :pswitch_8
    const-string v0, "MSG_ID_RESPONSE"

    goto :goto_0

    .line 614
    :pswitch_9
    const-string v0, "MSG_ID_SIM_READY"
...
.method private handleCommand(Lcom/android/internal/telephony/cat/CommandParams;Z)V
    ...
    const-string v1, "handleCommand with type:"
...
.method private handleRilMsg(Lcom/android/internal/telephony/cat/RilMessage;)V
    ...
    invoke-direct {p0, v2}, Lcom/android/internal/telephony/cat/CatService;->getMsgWhatString(I)Ljava/lang/String;
    ...
    const-string v2, " int handleRilMsg Method"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v5, "Reporting STK handleMessage with:"
    ...
    invoke-direct {p0, v5}, Lcom/android/internal/telephony/cat/CatService;->getMsgWhatString(I)Ljava/lang/String;
    ...
    .line 655
    iget-boolean v4, p0, Lcom/android/internal/telephony/cat/CatService;->isDefaultInit:Z
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/IccRecords;->getIccCard()Lcom/android/internal/telephony/IccCard;
    ...
    sput-object v4, Lcom/android/internal/telephony/cat/CatService;->STK_DEFAULT:Ljava/lang/String;

    .line 664
    .end local v3           #isUsimType:Z
    :cond_1
    :goto_1
    const/4 v4, 0x1

    iput-boolean v4, p0, Lcom/android/internal/telephony/cat/CatService;->isDefaultInit:Z
