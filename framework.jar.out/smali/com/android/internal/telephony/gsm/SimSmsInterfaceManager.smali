...
.field private static final EVENT_GET_GSM_SMS_CENTER_DONE:I = 0x8
...
.field private static final EVENT_SET_SMS_READ_DONE:I = 0x7

.field private static final EVENT_SMSS_DONE:I = 0x6
...
.field private final mCmgrLock:Ljava/lang/Object;

.field private mGsmSmsCenter:Ljava/lang/String;
...
.method public constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;Lcom/android/internal/telephony/SMSDispatcher;)V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->mGsmSmsCenter:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->mCmgrLock:Ljava/lang/Object;

    .line 75
    const/4 v0, -0x1

    iput v0, p0, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->mWriteIndex:I
    ...
    const-string/jumbo v1, "z129 GsmSMSDispatcher will be called."
...
.method static synthetic access$200(Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;)I
    .locals 1
    .parameter "x0"

    .prologue
    .line 47
    iget v0, p0, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->mWriteIndex:I
...
.method static synthetic access$202(Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;I)I
    ...
    .prologue
    .line 47
    iput p1, p0, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->mWriteIndex:I
...
.method public copyMessageToIccEf(I[B[B)I
    ...
    :try_start_0
    iput v2, p0, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->mWriteIndex:I
    ...
    .line 239
    iget v2, p0, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->mWriteIndex:I
...
.method public getCountSmsOnSim()I
    ...
    .prologue
    .line 303
    const-string v1, "getCountSmsOnSim"
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/IccFileHandler;->getCountSmsOnSim()I

    move-result v0

    .line 305
    .local v0, numberOnSim:I
    return v0
.end method
...
.method public setSmsPreStore(I)Z
    ...
    const-string/jumbo v2, "z263 setSmsPreStore preStore = "
...
.method public setUimSmsRead(IZ)Z
    ...
    invoke-interface {v2, p1, p2, v1}, Lcom/android/internal/telephony/CommandsInterface;->setUimSmsRead(IZLandroid/os/Message;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
