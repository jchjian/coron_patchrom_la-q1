...
.method private static parseRetrConfParts(Ljava/io/ByteArrayInputStream;)Lcom/google/android/mms/pdu/PduBody;
    .locals 23
    .parameter "pduDataStream"
    ...
    .line 765
    .local v12, map:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/Integer;Ljava/lang/Object;>;"
    move-object/from16 v0, p0

    invoke-static {v0, v12}, Lcom/google/android/mms/pdu/PduParser;->parseContentType(Ljava/io/ByteArrayInputStream;Ljava/util/HashMap;)[B
    ...
    .line 767
    invoke-virtual {v14, v4}, Lcom/google/android/mms/pdu/PduPart;->setContentType([B)V
    ...
    .line 775
    invoke-virtual {v14, v13}, Lcom/google/android/mms/pdu/PduPart;->setName([B)V
    ...
    invoke-static {v0, v14, v1}, Lcom/google/android/mms/pdu/PduParser;->parsePartHeaders(Ljava/io/ByteArrayInputStream;Lcom/google/android/mms/pdu/PduPart;I)Z
    ...
    .end local v17           #partHeaderLen:I
    :cond_5
    sget-object v20, Lcom/google/android/mms/pdu/PduContentTypes;->contentTypes:[Ljava/lang/String;
    ...
    .restart local v17       #partHeaderLen:I
    :cond_6
    if-gez v17, :cond_7
    ...
    invoke-static/range {v20 .. v21}, Ljava/lang/Long;->toOctalString(J)Ljava/lang/String;
    ...
    const-string v20, "application/oct-stream"
    ...
    .line 817
    :cond_9
    const-string v20, "debug-mms"

    const-string/jumbo v21, "z795 contentid is null."
    ...
    const-string/jumbo v22, "z797 contentid is "
    ...
    invoke-virtual {v0, v15, v1, v6}, Ljava/io/ByteArrayInputStream;->read([BII)I

    .line 833
    invoke-virtual {v14}, Lcom/google/android/mms/pdu/PduPart;->getContentTransferEncoding()[B

    move-result-object v16

    .line 834
    .local v16, partDataEncoding:[B
    if-eqz v16, :cond_b
    ...
    .line 838
    invoke-static {v15}, Lcom/google/android/mms/pdu/Base64;->decodeBase64([B)[B
    ...
    .line 847
    const-string v20, "Decode part data error!"

    invoke-static/range {v20 .. v20}, Lcom/google/android/mms/pdu/PduParser;->log(Ljava/lang/String;)V
    ...
    .line 841
    invoke-static {v15}, Lcom/google/android/mms/pdu/QuotedPrintable;->decodeQuotedPrintable([B)[B
    ...
    .end local v7           #encoding:Ljava/lang/String;
    :cond_d
    invoke-virtual {v14, v15}, Lcom/google/android/mms/pdu/PduPart;->setData([B)V

    .line 854
    .end local v15           #partData:[B
    .end local v16           #partDataEncoding:[B
    :cond_e
    invoke-static {v14}, Lcom/google/android/mms/pdu/PduParser;->checkPartPosition(Lcom/google/android/mms/pdu/PduPart;)I
    ...
    invoke-virtual {v2, v0, v14}, Lcom/google/android/mms/pdu/PduBody;->addPart(ILcom/google/android/mms/pdu/PduPart;)V
    ...
    const-string/jumbo v22, "z838 part is "
    ...
    .line 861
    invoke-virtual {v2, v14}, Lcom/google/android/mms/pdu/PduBody;->addPart(Lcom/google/android/mms/pdu/PduPart;)Z
...
.method public parse()Lcom/google/android/mms/pdu/GenericPdu;
    ...
    invoke-static {v13}, Lcom/google/android/mms/pdu/PduParser;->parseRetrConfParts(Ljava/io/ByteArrayInputStream;)Lcom/google/android/mms/pdu/PduBody;
